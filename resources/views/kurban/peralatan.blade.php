    ...
    <section class="section">
         <div class="row">
            <ol class="breadcrumb float-sm-left" style="margin-bottom: 10px; margin-left: 15px;">
                ...
                <li class="breadcrumb-item active">Daftar Peralatan Kegiatan Kurban</li>
            </ol>
        </div>
        <div class="section-header">
            <div class="row" style="margin:auto;">
                <div class="col-12">
                    <h1><i class="fa fa-address-book"></i> Daftar Peralatan  Kurban Masjid Ibnu Sina</h1>
                    <div></div>
                </div>
            </div>
        </div>
        <div class="section-body">
            <button class="btn btn-primary mt-3"  data-toggle="modal" id="togglemodal" data-target="#modalTambah">Tambah Peralatan </button>
            <div class="row">
                    ...
                    <table id="table_id1" class="table table-striped table-bordered " style="padding-bottom:20px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="font-status">{{$peralatan->status }}</td>
                                <td class="dt-center">
                                    <div class="btn-group mb-3" role="group" aria-label="Basic example" style="padding-left: 20px;">
                                        <a href="#" class="open-detail btn btn-icon btn-sm btn-info" data-toggle="modal" data-id="{{ $peralatan->id }}" data-target="#detailModal"><i class="fas fa-id-badge"></i> Detail</a>
                                        <a href="peralatan/{{$peralatan->id}}/edit" class="open-edit btn btn-icon btn-sm btn-primary" ><i class="fas fa-sync"></i></i>Perbarui</a>
                                        <a href="#" class="open-delete btn btn-icon btn-sm btn-danger" data-toggle="modal" data-id="{{ $peralatan->id }}" data-target="#deleteModal"><i class="fas fa-trash"></i> Hapus</a> 
                                    </div>
                                </td>
                            </tr>
                            @endforeach
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Menambahkan Peralatan </h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
            <form method="POST" action="{{route('tambahPeralatan')}}">
                            @csrf  
                        <div class="form-group">
                                <label>Nama Peralatan</label>
                                <input type="text" class="form-control" name="namaperalatan">
                        </div>
                        <div class="form-group">
                                <label>Jumlah</label>
                        ...
                        <div class="form-group">
                            <label>Satuan</label>
                            <select name="satuan"  class="form-control" style="margin-bottom:10px; width:100%;" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="keterangan" placeholder="contoh : 1 pak berisi 10 buah">
                        </div>
            </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="detailModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail Peralatan  Kegiatan Kurban</h5>
                ...
                <table class="table table-borderless" style="width:90%; margin: auto;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="detailTGLDitambahkan"></td>
                        </tr>
                        <tr>
                            <th scope="row">Terakhir  Diubah</th>
                            <td id="detailTGLDiubah"></td>
                        </tr>
                    </tbody>
                </table>
...
<div class="modal fade" tabindex="-1" role="dialog" id="deleteModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Hapus Data Peralatan Kegiatan Kurban</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Tutup">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script>
        $(document).on("click", ".open-delete", function() {
              ...
              var thisDataPeralatan = $(this).data('id');
              $(".modal-footer #id_delete").val(thisDataPeralatan);
              var linkDetail = "{{ route('home') }}/peralatan/detail/" + thisDataPeralatan;
              ...
              document.getElementById("pesan").innerHTML = "Apakah anda yakin ingin menghapus peralatan "+ obj.nama+'?';
        ...
        $.get(linkDetail, function(data) {
            ...
            $("#detailJumlah").html(obj.jumlah +' '+ obj.satuan);
            $("#detailStatus").html(obj.status);
            $("#detailKeterangan").html(obj.keterangan);
            $("#detailTGLDitambahkan").html(obj.tanggalPendaftaran);     
            $("#detailTGLDiubah").html(obj.terakhirDiubah);              
                  status_colorized(); 
        });
    });
